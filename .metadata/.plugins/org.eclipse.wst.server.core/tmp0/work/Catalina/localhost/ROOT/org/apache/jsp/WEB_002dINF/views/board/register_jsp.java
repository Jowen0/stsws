 ...
 * Generated at: 2021-03-09 06:10:02 UTC
...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("<script>\r\n");
      out.write("//스크립트도 외부로 빼줘야 한다.\r\n");
      out.write("\r\n");
      out.write("function movePage(){\r\n");
      out.write("\tself.location = \"/board/list\"; //window.location //this.location 상관없다(this가 window인 경우)\r\n");
      out.write("\t//alert(\"movePage\");\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function sendAjax(data) {\r\n");
      out.write("\t\r\n");
      out.write("\tconsole.log(\"sendAjax....\", data);\r\n");
      out.write("\t\r\n");
      out.write("\t//fetch - 비동기\r\n");
      out.write("\treturn fetch(\"/board/register\", \r\n");
      out.write("\t\t\t{method:\"post\", headers:{'Content-Type':'application/json'}, body:JSON.stringify(data)})\r\n");
      out.write("\t.then(res => {\r\n");
      out.write("\t\tif(!res.ok){\r\n");
      out.write("\t\t\tthrow new Error(res);\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\treturn res.text() //함수를 넣어도 되지만 화살표 함수를 쓴다. 자바스크립트에서는 화살표 함수라고 한다.\t\r\n");
      out.write("\t})\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t});\t//.then(result => ) //어싱크 어웨이트 개념이 필요하다.\r\n");
      out.write("\t\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("const data = {title:\"한글 제목\", content:\"게시물 내용\", writer:\"user00\"}; //객체를 찍어내야할 때는 JS class를 사용한다.\r\n");
      out.write("\r\n");
      out.write("const fnResult = sendAjax(data);\r\n");
      out.write("\r\n");
      out.write("/* fnResult.then(result => {\r\n");
      out.write("\tconsole.log(\"RESULT: \" + result);\r\n");
      out.write("}) */\r\n");
      out.write("\r\n");
      out.write("fnResult.then(function(result) {\r\n");
      out.write("\tconsole.log(\"RESULT: \" + result);\r\n");
      out.write("\t$(\"#registerModal\").modal('show')\r\n");
      out.write("\t//display:\r\n");
      out.write("})\r\n");
      out.write("\r\n");
      out.write("//위 코드를 이쁘게 만드는 방법 생각해보기\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\r\n");
